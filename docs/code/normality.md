...
!!! abstract "Summary"
    ...
    !!! example "Source Module"
        ...
        - [`ts_stat_tests.algorithms.normality`](https://github.com/data-science-extensions/ts-stat-tests/blob/main/src/ts_stat_tests/algorithms/normality.py).
        - [`ts_stat_tests.tests.normality`](https://github.com/data-science-extensions/ts-stat-tests/blob/main/src/ts_stat_tests/tests/normality.py).
